...
class _LoansPageState extends State<LoansPage> {
  ...
  Widget buildLoans(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) =>
          buildLoansGroupItem(context, groups[index]),
  ...
  Widget buildLoansGroupItem(BuildContext context, _LoansGroup loansGroup) {
    return Card(
      margin: const EdgeInsets.fromLTRB(16, 16, 16, 0),
      child: Column(children: [
        buildLoansGroupHeader(context, loansGroup),
        Divider(),
        for (final loan in loansGroup.loans) buildLoanItem(context, loan)
      ]),
    );
  }

  Widget buildLoansGroupHeader(BuildContext context, _LoansGroup loansGroup) {
    return Padding(
        ...
        children: [
          ...
          if (loansGroup.debtOfOtherPerson.isNotEmpty)
            Padding(
              ...
              child: buildLoanGroupSummaryItem(
                context,
                title: Text("#Dług"),
  ...
  Widget buildLoanGroupSummaryItem(
    BuildContext context, {
    Widget title,
    List<Money> values,
